							...
							<tbody id="myTable" class="especial">
								<tr>
									<td>
										<a href="cuidados_medicos_adultos.php">
											<li style="color: #61C7E2; " value="Cuidado de Adultos">Cuidado de Adultos</li>
										</a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td><a href="cuidados_medicos_rehabilitacion.php ">
											<li style="color: #333; " value="Rehabilitación">Rehabilitación</li>
										</a></td>
								</tr>
								<tr>
		...
		<div class="fondomedio">
			...
			<div align="right">
				...
				<section class="section-grid">
					<div class="grid-med">
						<div style="width: 45%;">
							<h2 class="preguntas" style="margin-left:-10px">Cuidados de Adultos</h2>
						</div>
						<div class="bloquepreguntas_int">
							<br>
							<p style="font-size:14px; text-align: justify;">
								Las necesidades sanitarias de las personas mayores son muy diferentes. Por lo general,
								tienen múltiples problemas de salud que requieren atención recurrente. Nuestros programas
								de asociación para el cuidado de ancianos están especialmente diseñados para mejorar de
								manera proactiva la salud y el bienestar de los ancianos.
								<br><br>
							...
							<br><br>
							<a style="color: #452167;">Nuestros programas están personalizados con una duración de 3 a 6 meses.</a>
							<br><br>
							<a style="color: #452167;">Nuestros planes de cuidado de ancianos involucran: </a>
							<br><br>

							<li style="text-align: justify;">Visitas domiciliarias periódicas de médicos y fisioterapeutas</li>
							<li style="text-align: justify;">Registros de salud personalizados</li>
							<li style="text-align: justify;">Entrega de medicamentos a domicilio</li>
							<li style="text-align: justify;">Investigaciones de laboratorio con tarifa descontada</li>
							<li style="text-align: justify;">Servicios de ambulancia en caso de alguna emergencia</li>
							</p>
							<br><br>
						</div>
					</div>
