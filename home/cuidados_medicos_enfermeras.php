							...
							<tbody id="myTable" class="especial">
								...
								<tr>
									<td><a href="cuidados_medicos_enfermeras.php ">
											<li style="color: #61C7E2; " value="Enfermeras">Enfermeras</li>
										</a></td>
								</tr>
								<tr>
		...
		<div class="fondomedio">
			...
			<div align="right">
				...
				<section class="section-grid">
					<div class="grid-med">
						<div style="width: 45%;">
							<h2 class="preguntas" style="margin-left:-10px">Enfermeras a Domicilio</h2>
						</div>
						<div class="bloquepreguntas_int">
							<br>

							<a style="color: #452167;">Visita de enfermería básica </a>
							<br><br>
							<li>Comprobación de vitales</li>
							<li>Vacunas</li>
							<li>Recolección de muestras de sangre</li>
							<li>Nebulización</li>
							<li>Enema</li>
							<li>Baño de asiento</li>
							<li>Cuidado de la higiene personal</li>
							<li>Monitoreo fetal</li>
							<li>Vendaje para úlceras por decúbito / Herida / Fístula</li>
							<li>Cuidado del yeso</li>
							<li>Monitorización de ECG</li>
							<li>Baño y masaje para bebés</li>
							<br><br>
							<a style="color: #452167;">Procedimientos</a>
							<br><br>
							<li>Vendaje para heridas postoperatorio</li>
							<li>Inserción de catéter de Foley</li>
							<li>Inserción y extracción del tubo Ryles</li>
							<li>Vendaje para vía PICC / vía central</li>
							<li>Transfusión de albúmina</li>
							<li>Lavado / irrigación de vejiga</li>
							<li>Administración y seguimiento de la TPN</li>
							<li>Colostomía y otras aplicaciones de ostomía</li>
							<li>Servicio de recogida ABG</li>
							<li>Aspiradoras para heridas </li>
							<li>Líquidos intravenosos / medicación intravenosa </li>
							</a>
							<br><br>
