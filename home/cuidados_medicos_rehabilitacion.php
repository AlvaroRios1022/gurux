							...
							<tbody id="myTable" class="especial">
								...
								<tr>
									<td><a href="cuidados_medicos_equipos.php">
											<li style="color: #333; " value="Equipos médicos">Equipos médicos</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="cuidados_medicos_examenes.php ">
											<li style="color: #333; " value="Exámenes">Exámenes</li>
										</a></td>
								</tr>
								<tr>
								...
								<tr>
									<td><a href="cuidados_medicos_medicos.php ">
											<li style="color: #333; " value="Médicos">Médicos</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="cuidados_medicos_rehabilitacion.php ">
											<li style="color: #61C7E2; " value="Rehabilitación">Rehabilitación</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="cuidados_medicos_vacunacion.php ">
											<li style="color: #333; " value="Vacunación">Vacunación</li>
										</a></td>
								</tr>
							</tbody>
						</table>
