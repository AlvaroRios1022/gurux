...
<body class="cabecera">
	...
	?>
		<div id="container2">
					...
					<nav>
						<ul align="right">
							<a href="servicios.php">
								<li class="rojoservicios" style="vertical-align: middle;"> SERVICIOS</li>
							</a>
			...
			<div class="barra" style="margin-top:-6px; ">
				<ul id="lista1">
					<li style="margin-left:-90px;" class="itemlista1"><a id="current" href="#" style="color:#fff; text-shadow: 1px 1px 1px black;"> HOME MÉDICOS </a></li>
					...
					<div>
						<table style="border: transparent !important;border-top: 0px !important ;color:transparent !important;border-radius: transparten;">
							<tbody id="myTable" class="especial">
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Alergólogo')">Alergólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Angiólogo')">Angiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cardiólogo')">Cardiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía cardiovascular')">Cirugía cardiovascular</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía general y del aparato digestivo')">Cirugía general y del aparato digestivo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía oral y maxilofacial')">Cirugía oral y maxilofacial</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía ortopédica y traumatología')">Cirugía ortopédica y traumatología</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía pediátrica')">Cirugía pediátrica</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía plástica, estética y reparadora')">Cirugía plástica, estética y reparadora</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Cirugía torácica')">Cirugía torácica</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Deportólogo')">Deportólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Dermatólogo')">Dermatólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Endocrinólogo')">Endocrinólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Enfermero')">Enfermero</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Epidemiólogo')">Epidemiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Estomatólogo')">Estomatólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Farmacólogo')">Farmacólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Fisiólogo')">Fisiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Fonoaudiólogo')">Fonoaudiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Forense')">Forense</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('General')">General</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Geriatra')">Geriatra</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Ginecólogo')">Ginecólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Hematólogo')">Hematólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Histólogo')">Histólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Inmunólogo')">Inmunólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Microbiólogo')">Microbiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Nefrólogo')">Nefrólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Neumólogo')">Neumólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Neurocirugía')">Neurocirugía</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Neurólogo')">Neurólogo</li>
										</a></td>
								</tr>

								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Endodoncista')">Odontólogo Endodoncista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo general')">Odontólogo general</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Odontopediatra')">Odontólogo Odontopediatra</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Ortodoncista')">Odontólogo Ortodoncista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Patólogo oral o Cirujano oral')">Odontólogo Patólogo oral o Cirujano oral</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Periodoncista')">Odontólogo Periodoncista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Odontólogo Prostodoncista')">Odontólogo Prostodoncista</li>
										</a></td>
								</tr>
								...
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Oncólogo')">Oncólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Ortopedista')">Ortopedista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Patólogo')">Patólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Pediatra')">Pediatra</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Podólogo')">Podólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Proctólogo')">Proctólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Psicoanalista')">Psicoanalista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Psicólogo')">Psicólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Psicoterapeuta')">Psicoterapeuta</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Psiquiatra')">Psiquiatra</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Quiropráctico')">Quiropráctico</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Radiólogo')">Radiólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Radioterapeuta')">Radioterapeuta</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Reumatólogo')">Reumatólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Sexólogo')">Sexólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Sofrólogo')">Sofrólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Terapeuta')">Terapeuta</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Toxicólogo')">Toxicólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Traumatólogo y Ortopedista')">Traumatólogo y Ortopedista</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Urólogo')">Urólogo</li>
										</a></td>
								</tr>
								<tr>
									<td><a href="#">
											<li style="color: #333; " onclick="filtroTipo('Virólogo')">Virólogo</li>
										</a></td>
								</tr>
	...
	<div class="fondomedio">
		...
		<div style=" background-color: #d6f0fc; ">
			...
			<select class="camposgenerales" style=" height:30px" name="filtro_ciudad" id="filtro_ciudad" onchange="change_ciudad(this)">
				<option value="">-----</option>
