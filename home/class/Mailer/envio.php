...
class EnvioModel {
  ...
  Public function enviopassword ($email, $email_subject,$pk){
    ...
    $mail->Username = 'noreply@guruxy.com';
    //Password to use for SMTP authentication
    $mail->Password = '1Noreply2';
    //Set who the message is to be sent from
    $mail->setFrom('noreply@guruxy.com', 'Notificaciones Guru');
  ...
  $body = file_get_contents(dirname(__FILE__).'/plantilla_password.html');
