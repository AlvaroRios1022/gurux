...
<html lang="en">
                    ...
                    <div class="flex-item-right" style="background-color: #E3DAEC; " align="left"><br><br>
                        ...
                        <select  id="constructor" name="constructor" class="cajas"> 
							...
							<option value="Calentadores de Agua">Calentadores de Agua</option>
								...
								<tr><td><li class="sinfondo" style="color: #333; " value="title">Profesional de Construcción:</li></td></tr>
	...
	<option value="Operador de maquinaria de construcción">Operador de maquinaria de construcción</option>	<option Operador de máquinas para trabajar la madera')" value="Operador de máquinas para trabajar la madera">Operador de máquinas para trabajar la madera</option>
